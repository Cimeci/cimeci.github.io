...
export const Stacks = () => {
	...
	const languages_web = [
		...
		{ name: 'JavaScript', icon: 'https://upload.wikimedia.org/wikipedia/commons/9/99/Unofficial_JavaScript_logo_2.svg', color: 'bg-gradient-to-br from-yellow-400 to-yellow-600' },
	...
	const languages = [
		...
		{ name: 'Assembly', icon: `${base}4/48/Netwide_Assembler.svg`, color: 'bg-gradient-to-br from-red-600 to-gray-800' },
	]

	return (
		<div className="flex flex-col justify-center items-center w-full min-h-[92.3vh] p-8 gap-30">
			<div id="web-stacks" className="flex flex-col justify-center items-center gap-10">
				<p className="text-xl">WEB STACKS</p>
				<div id="languages-web" className="flex flex-wrap gap-6 justify-center md:justify-start">
			...
			<div id="stacks" className="flex flex-col justify-center items-center gap-10">
				<p className="text-xl">STACKS</p>

				<div id="languages" className="flex flex-wrap gap-6 justify-center md:justify-start">
